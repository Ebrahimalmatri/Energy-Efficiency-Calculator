...
A Python tool to calculate home power consumption and estimate cost savings through sustainable practices
## Scientific Principle
The program is based on the fundamental equation of electrical energy: E= {P/t}/1000
Where:
E: Energy consumed in kilowatt-hours (kWh)
P: Power rating of the appliance in Watts (W)
t: Duration of usage in hours (h)
## Objectives
